...
export function useInputState() {
  ...
  const setters = useMemo(() => {
    ...
    return {
      ...
      setDeckSlideCount: ((v) => set("deckSlideCount", v)) as Setter<AppInputState, "deckSlideCount">,
      setSelectedBlockContext: ((v) => set("selectedBlockContext", v)) as Setter<AppInputState, "selectedBlockContext">,
  ...
  return {
    ...
    deckSlideCount: state.deckSlideCount,
    selectedBlockContext: state.selectedBlockContext,
...
export function useUIState() {
  ...
  const setters = useMemo(() => {
    ...
    return {
      ...
      setProjectAssetsOpen: ((v) => set("isProjectAssetsOpen", v)) as Setter<AppUIState, "isProjectAssetsOpen">,
  ...
  return {
    ...
    isProjectAssetsOpen: state.isProjectAssetsOpen,
